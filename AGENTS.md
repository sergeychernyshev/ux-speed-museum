...
- [x] **Exhibit 1: The Slow Starter.**
  ...
  - **Visuals:** Rendering progress bars and dual-value millisecond timers ({start} - {current}ms). Timers are positioned directly above each experience frame and are left-aligned.
